...
// The relay's ark-refresh endpoints (/ark-refresh/subscribe and
// /ark-refresh/expiry) were consumed here until the silent-push
// background-refresh machinery was removed — the app no longer feeds
// the relay's push scanner. The relay-side scanner can be
// decommissioned once no old clients remain.
